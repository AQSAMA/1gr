...
and ultimately improve the success rate of drug development (Vamathevan et al., 2019).
...
(Sanchez-Lengeling & Aspuru-Guzik, 2018; Paul et al., 2021).
...
examination of the history of the present and other threads (Maia et al., 2020).
...
the probes and protein (Liang et al., 1998; Sliwoski et al., 2014).
...
latter, as in GNINA (Sliwoski et al., 2014).
...
compounds targeting desired properties (Devi et al., 2015).
...
long timeline (Blanco-González et al., 2023).
...
and optimizing all of them at once is a big challenge (Qureshi et al., 2023).
...
challenges, underscoring the need for further investigation (Karimian et al., 2022).
...
diagnostics and video surveillance (Goodfellow et al., 2016; Gawehn et al., 2016).
...
adapting to each other (Goodfellow et al., 2016).
...
and adversarial error (Goodfellow et al., 2016).
...
and appended to each molecule during training (Segler et al., 2018; Tong et al., 2021).
...
need to work in synergy (Qureshi et al., 2023).
...
and improve precision medicine (Gaul & Cuesta-Lopez, 2024).
...
accuracy, reaching 78% (Gaul & Cuesta-Lopez, 2024).
...
(Paul et al., 2021; Vamathevan et al., 2019).
...
during its usage in patients (Waring et al., 2015).
...
predict the effects of in vivo toxicity (Qureshi et al., 2023).
...
activity based on objectives such as toxicity (Korotcov et al., 2017).
...
accuracy of 75% (Qureshi et al., 2023).
...
predictive value of 78% for binary (yes/no) DILI prediction (Qureshi et al., 2023).
...
accuracy for EI and 96% for EC (Qureshi et al., 2023).
...
across all investigated drug categories (Qureshi et al., 2023).
